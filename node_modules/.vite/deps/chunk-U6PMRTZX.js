...
var _default = (function() {
  ...
  return _createClass(_default2, [{
    ...
    value: function get(parentInstance, slots) {
      ...
      return s2(computed) ? computed : null;
    }
  }, {
    key: "_isMatched",
...
var script15 = {
  ...
  watch: {
    ...
    items: {
      handler: function handler5(newValue, oldValue) {
  ...
  methods: {
    ...
    getContentPosition: function getContentPosition() {
      if (this.content) {
        var style6 = getComputedStyle(this.content);
        var left = parseFloat(style6.paddingLeft) + Math.max(parseFloat(style6.left) || 0, 0);
        var right = parseFloat(style6.paddingRight) + Math.max(parseFloat(style6.right) || 0, 0);
        var top = parseFloat(style6.paddingTop) + Math.max(parseFloat(style6.top) || 0, 0);
        var bottom = parseFloat(style6.paddingBottom) + Math.max(parseFloat(style6.bottom) || 0, 0);
        return {
          left,
          right,
          top,
    ...
    setSpacerSize: function setSpacerSize() {
      ...
      if (items) {
        ...
        var setProp = function setProp2(_name, _value, _size) {
          ...
          return _this6.spacerStyle = _objectSpread(_objectSpread({}, _this6.spacerStyle), _defineProperty4({}, "".concat(_name), (_value || []).length * _size + _cpos + "px"));
        };
        if (both) {
...
var script16 = {
  ...
  methods: {
    ...
    isValidOption: function isValidOption(option2) {
      return s2(option2) && !(this.isOptionDisabled(option2) || this.isOptionGroup(option2));
    },
  ...
  computed: {
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread2(_objectSpread2({}, group), {}, _defineProperty5({}, typeof _this17.optionGroupChildren === "string" ? _this17.optionGroupChildren : "items", _toConsumableArray3(filteredItems))));
          });
    ...
    filterResultMessageText: function filterResultMessageText() {
      return s2(this.visibleOptions) ? this.filterMessageText.replaceAll("{0}", this.visibleOptions.length) : this.emptyFilterMessageText;
    },
    ...
    isClearIconVisible: function isClearIconVisible() {
      return this.showClear && this.d_value != null && s2(this.options);
    },
    ...
    dropdownIconDataP: function dropdownIconDataP() {
      return f(_defineProperty5({}, this.size, this.size));
    },
    overlayDataP: function overlayDataP() {
      return f(_defineProperty5({}, "portal-" + this.appendTo, "portal-" + this.appendTo));
    }
  },
  directives: {
    ripple: Ripple
...
//# sourceMappingURL=chunk-U6PMRTZX.js.map
