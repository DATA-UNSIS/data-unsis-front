import {
  script as script3
} from "./chunk-PB3CWYB5.js";
import {
  script as script4
} from "./chunk-DEZOM4BL.js";
import {
  BaseDirective,
  script as script2
} from "./chunk-6MU6UDAO.js";
import {
  script
...
var script10 = {
  ...
  methods: {
    ...
    onMaskClick: function onMaskClick(event) {
      var isBarActionsClicked = _(event.target, "data-pc-section-group", "action") || event.target.closest('[data-pc-section-group="action"]');
...
function render6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("span", mergeProps({
    ...
    }, _objectSpread2(_objectSpread2({}, _ctx.$attrs), _ctx.ptm("image"))), null, 16)];
  ...
  }, _objectSpread2(_objectSpread2({}, _ctx.previewButtonProps), _ctx.ptm("previewMask"))), [renderSlot(_ctx.$slots, _ctx.$slots.previewicon ? "previewicon" : "indicatoricon", {}, function() {
