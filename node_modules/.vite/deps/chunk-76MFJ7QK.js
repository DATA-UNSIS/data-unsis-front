...
var BaseDirective = {
  ...
  _getPTDatasets: function _getPTDatasets2() {
    ...
    var key = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
    var datasetPrefix = "data-pc-";
    return _objectSpread3(_objectSpread3({}, key === "root" && _defineProperty3({}, "".concat(datasetPrefix, "name"), g(instance.$name))), {}, _defineProperty3({}, "".concat(datasetPrefix, "section"), g(key)));
  },
...
var Ripple = BaseRipple.extend("ripple", {
  ...
  methods: {
    ...
    createRipple: function createRipple(el) {
      ...
      if (!ink) {
        ink = U("span", _defineProperty4(_defineProperty4({
          role: "presentation",
          "aria-hidden": true,
          "data-p-ink": true,
...
//# sourceMappingURL=chunk-76MFJ7QK.js.map
