...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w2(t2), s4 = d2.height, a2 = d2.width, u = e.offsetHeight, c2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g4 = $2(), it = k2(), lt = h(), L, N3, ot = "top";
...
var ue2 = (e = {}, t2, r, s4) => {
  if (t2) {
    let { variable: i2, options: a2 } = S2.defaults || {}, { prefix: n, transform: l2 } = (e == null ? void 0 : e.options) || a2 || {}, o = z(t2, k3) ? t2 : `{${t2}}`;
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  if (s(t2) && r.transform !== "strict") {
    ...
    l2 = `${q2}${Z}`, o = [.../* @__PURE__ */ new Set([...U3, ...I2, ...W3])], c2 = m(j2, { dt: E2 });
  }
...
//# sourceMappingURL=chunk-OAGYYKUY.js.map
