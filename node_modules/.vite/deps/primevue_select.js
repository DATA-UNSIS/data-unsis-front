import {
  FilterService
} from "./chunk-MUVSST7V.js";
import {
  Ripple,
  script as script4
} from "./chunk-B6H3HQRY.js";
import {
  script as script3,
  script2 as script5
} from "./chunk-BMOJ43A3.js";
import {
  script as script2
} from "./chunk-3MBPAMVK.js";
import "./chunk-55WKOS6K.js";
import {
  script
} from "./chunk-3GDCRYIY.js";
import {
  $t,
  At,
  BaseStyle,
...
var script15 = {
  ...
  methods: {
    ...
    getContentPosition: function getContentPosition() {
      if (this.content) {
        var style5 = getComputedStyle(this.content);
        var left = parseFloat(style5.paddingLeft) + Math.max(parseFloat(style5.left) || 0, 0);
        var right = parseFloat(style5.paddingRight) + Math.max(parseFloat(style5.right) || 0, 0);
        var top = parseFloat(style5.paddingTop) + Math.max(parseFloat(style5.top) || 0, 0);
        var bottom = parseFloat(style5.paddingBottom) + Math.max(parseFloat(style5.bottom) || 0, 0);
        return {
          left,
          right,
          top,
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread2(_objectSpread2({}, group), {}, _defineProperty4({}, typeof _this17.optionGroupChildren === "string" ? _this17.optionGroupChildren : "items", _toConsumableArray2(filteredItems))));
          });
...
script16.render = render9;
export {
  script16 as default
};
//# sourceMappingURL=primevue_select.js.map
