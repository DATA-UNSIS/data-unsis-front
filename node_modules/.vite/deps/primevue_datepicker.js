...
var script14 = {
  ...
  methods: {
    ...
    isValidSelection: function isValidSelection(value) {
      ...
      if (this.isSingleSelection()) {
        ...
        return _this10.isSelectable(v2.getDate(), v2.getMonth(), v2.getFullYear(), false);
      })) {
        if (this.isRangeSelection()) {
    ...
    parseDate: function parseDate(value, format) {
      ...
      value = _typeof4(value) === "object" ? value.toString() : value + "";
      if (value === "") {
        return null;
      }
        ...
        case "ArrowDown": {
          ...
          if (nextRow) {
            ...
            var hasNextFocusableDate = nextTableRows.find(function(el) {
              ...
              return !Q(focusCell2, "data-p-disabled");
            });
  ...
  components: {
    ...
    ChevronLeftIcon: script10,
    ChevronRightIcon: script8,
    ChevronUpIcon: script11,
