...
function D(t2, e, o = true) {
  var n, r, i2, l2;
  if (t2) {
    let d2 = t2.offsetParent ? { width: t2.offsetWidth, height: t2.offsetHeight } : w(t2), s4 = d2.height, a2 = d2.width, u = e.offsetHeight, c2 = e.offsetWidth, f2 = e.getBoundingClientRect(), g4 = $(), it = k(), lt = h(), L, N3, ot = "top";
    f2.top + u + s4 > lt.height ? (L = f2.top + g4 - s4, ot = "bottom", L < 0 && (L = g4)) : L = u + f2.top + g4, f2.left + a2 > lt.width ? N3 = Math.max(0, f2.left + it + c2 - a2) : N3 = f2.left + it, V(t2) ? t2.style.insetInlineEnd = N3 + "px" : t2.style.insetInlineStart = N3 + "px", t2.style.top = L + "px", t2.style.transformOrigin = ot, o && (t2.style.marginTop = ot === "bottom" ? `calc(${(r = (n = x(/-anchor-gutter$/)) == null ? void 0 : n.value) != null ? r : "2px"} * -1)` : (l2 = (i2 = x(/-anchor-gutter$/)) == null ? void 0 : i2.value) != null ? l2 : "");
  }
}
function S(t2, e) {
...
function _(t2, e, o) {
  return p(t2) ? Q(t2, e) === o : false;
}
function tt() {
  return !!(typeof window != "undefined" && window.document && window.document.createElement);
}
function It(t2, e = "") {
  return p(t2) ? t2.matches(`button:not([tabindex = "-1"]):not([disabled]):not([style*="display:none"]):not([hidden])${e},
...
function F(e, t2 = "", n = {}) {
  let r = g2(t2).split("."), o = r.shift();
  if (o) {
    if (i(e)) {
      let u = Object.keys(e).find((f2) => g2(f2) === o) || "";
...
function v2(e) {
  return p2(e, false) ? e[0].toUpperCase() + e.slice(1) : e;
}
function ee(e) {
...
function de(e, t2 = {}) {
  ...
  for (; o.length; ) {
    ...
    for (let u in m2) {
      let h2 = m2[u], f2 = ve(h2), p3 = z2(u, a2) ? Q2(d2) : Q2(d2, ee(u));
...
var b3 = { regex: { rules: { class: { pattern: /^\.([a-zA-Z][\w-]*)$/, resolve(e) {
  ...
  var R3, T2, j2, O2, M3, z3, V2;
  let { preset: a2, options: n } = t2, l2, o, c2, m2, d2, u, h2;
  if (s(a2) && n.transform !== "strict") {
    let { primitive: L, semantic: te, extend: re } = a2, f2 = te || {}, { colorScheme: K3 } = f2, A2 = v3(f2, ["colorScheme"]), x3 = re || {}, { colorScheme: X } = x3, G2 = v3(x3, ["colorScheme"]), p3 = K3 || {}, { dark: U3 } = p3, B2 = v3(p3, ["dark"]), y3 = X || {}, { dark: I2 } = y3, H = v3(y3, ["dark"]), W3 = s(L) ? this._toVariables({ primitive: L }, n) : {}, q3 = s(A2) ? this._toVariables({ semantic: A2 }, n) : {}, Z = s(B2) ? this._toVariables({ light: B2 }, n) : {}, pe = s(U3) ? this._toVariables({ dark: U3 }, n) : {}, fe2 = s(G2) ? this._toVariables({ semantic: G2 }, n) : {}, ye = s(H) ? this._toVariables({ light: H }, n) : {}, Se = s(I2) ? this._toVariables({ dark: I2 }, n) : {}, [Me, ze] = [(R3 = W3.declarations) != null ? R3 : "", W3.tokens], [Ke, Xe] = [(T2 = q3.declarations) != null ? T2 : "", q3.tokens || []], [Ge, Ue] = [(j2 = Z.declarations) != null ? j2 : "", Z.tokens || []], [Be, Ie] = [(O2 = pe.declarations) != null ? O2 : "", pe.tokens || []], [He, We] = [(M3 = fe2.declarations) != null ? M3 : "", fe2.tokens || []], [qe, Ze] = [(z3 = ye.declarations) != null ? z3 : "", ye.tokens || []], [Fe, Je] = [(V2 = Se.declarations) != null ? V2 : "", Se.tokens || []];
    ...
    d2 = `${et2}${tt2}`, u = [.../* @__PURE__ */ new Set([...We, ...Ze, ...Je])], h2 = m(a2.css, { dt: E2 });
  }
  ...
  if (s(t2) && r.transform !== "strict") {
    let y3 = e.replace("-directive", ""), m2 = t2, { colorScheme: R3, extend: T2, css: j2 } = m2, O2 = v3(m2, ["colorScheme", "extend", "css"]), d2 = T2 || {}, { colorScheme: M3 } = d2, z3 = v3(d2, ["colorScheme"]), u = R3 || {}, { dark: V2 } = u, L = v3(u, ["dark"]), h2 = M3 || {}, { dark: te } = h2, re = v3(h2, ["dark"]), K3 = s(O2) ? this._toVariables({ [y3]: g3(g3({}, O2), z3) }, r) : {}, A2 = s(L) ? this._toVariables({ [y3]: g3(g3({}, L), re) }, r) : {}, X = s(V2) ? this._toVariables({ [y3]: g3(g3({}, V2), te) }, r) : {}, [G2, U3] = [(f2 = K3.declarations) != null ? f2 : "", K3.tokens || []], [B2, I2] = [(x3 = A2.declarations) != null ? x3 : "", A2.tokens || []], [H, W3] = [(p3 = X.declarations) != null ? p3 : "", X.tokens || []], q3 = this.transformCSS(y3, `${G2}${B2}`, "light", "variable", r, i2, a2, n), Z = this.transformCSS(y3, H, "dark", "variable", r, i2, a2, n);
    l2 = `${q3}${Z}`, o = [.../* @__PURE__ */ new Set([...U3, ...I2, ...W3])], c2 = m(j2, { dt: E2 });
  }
  ...
  let a2 = function(l2, o = {}, c2 = []) {
    ...
    Object.entries(l2).forEach(([m2, d2]) => {
      ...
      i(d2) ? n(d2, u, h2) : (i2[u] || (i2[u] = { paths: [], computed: (f2, x3 = {}, p3 = []) => {
  ...
  if (s(t2)) {
    ...
    if (s4 !== "style") {
      ...
      t2 = r === "dark" ? c2.reduce((m2, { type: d2, selector: u }) => (s(u) && (m2 += u.includes("[CSS]") ? u.replace("[CSS]", t2) : this.getSelectorRule(u, l2, d2, t2)), m2), "") : C2(l2 != null ? l2 : ":root", t2);
    }
    if (o) {
...
var S2 = { defaults: { variable: { prefix: "p", selector: ":root", excludedKeyRegex: /^(primitive|semantic|components|directives|variables|colorscheme|light|dark|common|root|states|extend|css)$/gi }, options: { prefix: "p", darkModeSelector: "system", cssLayer: false } }, _theme: void 0, _layerNames: /* @__PURE__ */ new Set(), _loadedStyleNames: /* @__PURE__ */ new Set(), _loadingStyles: /* @__PURE__ */ new Set(), _tokens: {}, update(e = {}) {
  let { theme: t2 } = e;
  t2 && (this._theme = $3(g3({}, t2), { options: g3(g3({}, this.defaults.options), t2.options) }), this._tokens = b3.createTokens(this.preset, this.defaults), this.clearLoadedStyleNames());
}, get theme() {
  return this._theme;
}, get preset() {
  var e;
  ...
  this._theme = $3(g3({}, this.theme), { preset: e }), this._tokens = b3.createTokens(e, this.defaults), this.clearLoadedStyleNames(), N2.emit("preset:change", e), N2.emit("theme:change", this.theme);
}, getOptions() {
  return this.options;
}, setOptions(e) {
...
var BaseStyle = {
  ...
  getStyleSheet: function getStyleSheet() {
    ...
    if (this.css) {
      ...
      var _props = Object.entries(props).reduce(function(acc, _ref2) {
        var _ref3 = _slicedToArray(_ref2, 2), k4 = _ref3[0], v4 = _ref3[1];
        return acc.push("".concat(k4, '="').concat(v4, '"')) && acc;
      }, []).join(" ");
  ...
  getThemeStyleSheet: function getThemeStyleSheet(params) {
    ...
    if (this.style) {
      ...
      var _style = G(S2.transformCSS(name, _css));
      var _props = Object.entries(props).reduce(function(acc, _ref4) {
        var _ref5 = _slicedToArray(_ref4, 2), k4 = _ref5[0], v4 = _ref5[1];
        return acc.push("".concat(k4, '="').concat(v4, '"')) && acc;
      }, []).join(" ");
...
//# sourceMappingURL=chunk-26FWA5R7.js.map
