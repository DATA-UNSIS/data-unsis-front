import {
  script as script3
} from "./chunk-BOOSCZ7K.js";
import {
  Ripple,
  script as script2
} from "./chunk-7YJC3T7W.js";
import "./chunk-6MU6UDAO.js";
import {
  script
} from "./chunk-HGXNSZYQ.js";
import "./chunk-VA6VAPVU.js";
import {
  BaseStyle,
  Q,
  a,
  ...
  methods: {
    ...
    isItemActive: function isItemActive3(item2) {
      return this.expandedKeys ? this.expandedKeys[this.getItemProp(item2, "key")] : this.multiple ? this.activeItems.some(function(subItem) {
        return k(item2, subItem);
      }) : k(item2, this.activeItem);
    },
    ...
    isItemFocused: function isItemFocused2(item2) {
      return k(item2, this.activeItem);
    },
    isItemGroup: function isItemGroup3(item2) {
      return s(item2.items);
    },
    ...
    onHeaderArrowDownKey: function onHeaderArrowDownKey(event) {
      var rootList = Q(event.currentTarget, "data-p-active") === true ? z(event.currentTarget.nextElementSibling, '[data-pc-section="rootlist"]') : null;
    ...
    onHeaderArrowUpKey: function onHeaderArrowUpKey(event) {
      ...
      var rootList = Q(prevHeader, "data-p-active") === true ? z(prevHeader.nextElementSibling, '[data-pc-section="rootlist"]') : null;
      rootList ? bt(rootList) : this.updateFocusedHeader({
        originalEvent: event,
        focusOnNext: false
      });
    ...
    onHeaderEnterKey: function onHeaderEnterKey(event, item2) {
      var headerAction = z(event.currentTarget, '[data-pc-section="headerlink"]');
    ...
    updateFocusedHeader: function updateFocusedHeader(event) {
      ...
      var header2 = selfCheck ? z(panelElement, '[data-pc-section="header"]') : focusOnNext ? this.findNextHeader(panelElement) : this.findPrevHeader(panelElement);
    ...
    changeActiveItem: function changeActiveItem(event, item2) {
      ...
      if (!this.isItemDisabled(item2)) {
        ...
        this.activeItem = selfActive ? item2 : this.activeItem && k(item2, this.activeItem) ? null : item2;
        if (this.multiple) {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", mergeProps({
    ...
    return openBlock(), createElementBlock(Fragment, {
      ...
      ref_for: true
    }, $options.getPTOptions("headerIcon", item2, index)), null, 16)) : createCommentVNode("", true), createBaseVNode("span", mergeProps({
